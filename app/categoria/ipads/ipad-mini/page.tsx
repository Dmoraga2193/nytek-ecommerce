...
async function getProducts(searchParams: Awaited<PageProps["searchParams"]>) {
  try {
    console.log("Fetching iPad mini products with params:", searchParams);
  ...
  return (
    <div className="min-h-screen pt-32">
      <div className="container mx-auto px-4">
        <CategoryHeader
          title="iPad mini"
          description="Descubre el iPad mini, potente y compacto, perfecto para la creatividad y productividad en movimiento."
          total={total}
        />
