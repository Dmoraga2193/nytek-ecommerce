  ...
  return (
    <div className="min-h-screen pt-32">
      <div className="container mx-auto px-4">
        <CategoryHeader
          title="iPhone 15"
          description="Experimenta el poder y la innovación del iPhone 15, con su impresionante sistema de cámaras y rendimiento excepcional."
          total={total}
        />

        <div className="flex flex-col lg:flex-row gap-8">
          <aside className="w-full lg:w-64">
            <ProductFilters category="iPhone" />
          </aside>
